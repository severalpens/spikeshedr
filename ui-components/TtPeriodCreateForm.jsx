...
import { createTtPeriod } from "./graphql/mutations";
const client = generateClient();
export default function TtPeriodCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setTimerTaskId(initialValues.TimerTaskId);
    setErrors({});
  };
  const validations = {
    StartTime: [],
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createTtPeriod.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "TtPeriodCreateForm")}
      {...rest}
    >
      <TextField
        label="Start time"
